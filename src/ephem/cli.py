...
def add_display_options(parser):
    ...
    display.add_argument('--format', choices=['glyphs', 'names', 'short', 'mixed'], default='mixed', help="choose display format: glyphs, full names, truncated names. default mixes planetary glyphs with full sign names.")
