...
def parse_arguments():
    parser = argparse.ArgumentParser(description="A horoscope CLI that prints the chart of the moment.")
    # input
    ...
    parser.add_argument('-s', '--short', action='store_true', help="print truncated sign names and exclude arc seconds, e.g. 21 Sco 2")
    ...
    parser.add_argument('-a', '--approximate', action='store_true', help="given a date but no time, use UTC noon and don't print angles")
