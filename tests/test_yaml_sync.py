...
class TestYamlSync(unittest.TestCase):
    ...
    def test_chart_to_yaml_dict(self):
        ...
        with patch('ephem.yaml_sync.datetime') as mock_datetime:
            mock_datetime.now.return_value = datetime.fromisoformat('2025-09-10T12:00:00')
            mock_datetime.fromisoformat = datetime.fromisoformat  # needed if chart_to_yaml_dict calls it
    ...
    def test_sync_yaml_to_db(self, mock_add_chart, mock_load_yaml, mock_view_charts, mock_find_files):
    ...
    def test_full_sync(self, mock_sync_db, mock_export, mock_view_charts, 
                      mock_find_files, mock_create_tables):
