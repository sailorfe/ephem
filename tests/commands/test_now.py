...
class TestNowCommand(unittest.TestCase):
    ...
    def test_run_prints_output(self, mock_get_moment, mock_get_locale, mock_get_julian_days, 
        ...
        # patch print to capture outputs
        with patch('builtins.print') as mock_print:
            now.run(args=MagicMock())

        # assert print called with each line of output
