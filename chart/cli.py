...
def parse_arguments():
    ...
    now_display.add_argument('-b', '--brief', action='store_true', help='print truncated placements, e.g. 21 Sco 2')
    ...
    chart_display.add_argument('-b', '--brief', action='store_true', help='print truncated placements, e.g. 21 Sco 2')
